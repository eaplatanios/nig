...
consensus_configurations = [
    ('Majority 0.0', {'consensus_method': nig.MajorityVote(trainable=False),
                      'consensus_loss_weight': 0.0,
                      'consensus_loss_metric': None,
                      'first_consensus': 10}),
    ('Majority 0.1', {'consensus_method': nig.MajorityVote(trainable=False),
                      'consensus_loss_weight': 0.1,
                      'consensus_loss_metric': None,
                      'first_consensus': 10}),
    # ('Majority 0.5', {'consensus_method': nig.MajorityVote(trainable=False),
    #                   'consensus_loss_weight': 0.5,
    #                   'consensus_loss_metric': None,
    #                   'first_consensus': 10}),
    ('Majority 1.0', {'consensus_method': nig.MajorityVote(trainable=False),
                      'consensus_loss_weight': 1.0,
                      'consensus_loss_metric': None,
                      'first_consensus': 10}),
    ('Trainable Majority 0.0', {'consensus_method': nig.MajorityVote(trainable=True),
                                'consensus_loss_weight': 0.0,
                                'consensus_loss_metric': None,
                                'first_consensus': 10,
    ...
    ('Trainable Majority 0.1', {'consensus_method': nig.MajorityVote(trainable=True),
                                'consensus_loss_weight': 0.1,
                                'consensus_loss_metric': None,
                                'first_consensus': 10,
                                'first_consensus_max_iter': 1000,
                                'consensus_update_frequency': 10,
                                'consensus_update_max_iter': 500}),
    # ('Trainable Majority 0.5', {'consensus_method': nig.MajorityVote(trainable=True),
    #                             'consensus_loss_weight': 0.5,
    #                             'consensus_loss_metric': None,
    #                             'first_consensus': 10,
    #                             'first_consensus_max_iter': 1000,
    #                             'consensus_update_frequency': 10,
    #                             'consensus_update_max_iter': 500}),
    ('Trainable Majority 1.0', {'consensus_method': nig.MajorityVote(trainable=True),
                                'consensus_loss_weight': 1.0,
                                'consensus_loss_metric': None,
                                'first_consensus': 10,
                                'first_consensus_max_iter': 1000,
